...
<head>
  ...
  <title>Rischma Fachirah - Index</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark p-3">
        <div class="container">
          <a class="navbar-brand" href="index.php">Rischma</a>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
              <div class="icon-box">
                <div class="icon"><i class="bx bx-world"></i></div>
                <h4 class="title"><a href="">Organisasi</a></h4>
                <p class="description"></p>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
              <div class="icon-box">
                ...
                <h4 class="title"><a href="">Kreativitas</a></h4>
                <p class="description"></p>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
              <div class="icon-box">
                ...
                <h4 class="title"><a href="">Membaca</a></h4>
                <p class="description"></p>
              </div>
            </div>
